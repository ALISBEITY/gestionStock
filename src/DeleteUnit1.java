...
class DeleteUnit1 extends JInternalFrame implements ActionListener
{
	Connection con;
	ResultSet rs;
	Statement st;
	...
	JComboBox cmb1;
	JButton btnfirst,btnnext,btnprev,btnlast,btndelete;
	...
	String unit;
	public DeleteUnit1(JFrame parent)
	{
		super("Delete Unit-1",true,true);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(obj==btndelete)
		{
			...
			if(!str1.equals("") && !unit.equals("")&& !str2.equals("")&& !str3.equals("") && !str4.equals("") && !str5.equals("") && !str6.equals("") && !str7.equals("")&& !str8.equals("")&& !str9.equals(""))
			{
				...
				qry="delete from product where id="+txtId.getText();
				
				try
				{				
					st.executeUpdate(qry);
					JOptionPane.showMessageDialog(null, "Record Deleted sucessfully.","WARNING!!",JOptionPane.WARNING_MESSAGE);
				}
